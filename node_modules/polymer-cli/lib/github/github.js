...
class Github {
    ...
    getSemverRelease(semverRange) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this._github.repos.listReleases({
                owner: this._owner,
                repo: this._repo,
                per_page: 100,
            });
    ...
    getBranch(branchName) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._github.repos.getBranch({ owner: this._owner, repo: this._repo, branch: branchName });
    ...
    getTag(tagName) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._github.repos.getReleaseByTag({ owner: this._owner, repo: this._repo, tag: tagName });
